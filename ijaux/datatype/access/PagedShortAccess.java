...
public class PagedShortAccess extends PagedAccess<Short> {
	
	private short [][] spixels;
	
	private int mask=shortMask;
	
	public PagedShortAccess(Object cpixels, Indexing<int[]> aind) {
		super(cpixels, aind);
		spixels=(short[][]) pixels;
		pageSize=spixels[0].length;
	}
